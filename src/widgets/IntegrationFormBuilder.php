...
use hipanel\modules\integrations\forms\IntegrationFormInterface;
 ...
 */
class IntegrationFormBuilder extends ActiveForm
{
     ...
     * @return null|string
     */
    public function renderForm(IntegrationFormInterface $model): ?string
    {
        $form = null;
        foreach ($model->getFormConfig() as $attribute => $settings) {
            $form .= $this->renderField($model, $attribute, $settings);
        }
